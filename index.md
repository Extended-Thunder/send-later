...
-   [Caveats and known issues](#caveats)
    -   [Send Later doesn't work with mail servers that discard its "X-Send-Later" headers](#bad-mail-servers)
    -   [Thunderbird must be running for scheduled messages to be sent](#running)
...
-   [Advanced usage](#advanced)
    ...
    -   [Making "Send" do "Send Later" only some of the time](#dynamic_sendbutton)
    -   [Checking for scheduled messages more than once per minute](#milliseconds)
-   [Troubleshooting](#troubleshooting)
    -   [Messages don't send or send multiple times](#outbox)
        -   [Send errors with Gmail when Thunderbird is configured to save copies](#gmail)
    -   [Debug logging](#debug)
