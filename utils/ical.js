// https://webextension-api.thunderbird.net/en/latest/how-to/contacts.html#howto-contacts
// https://github.com/kewisch/ical.js/releases
  ...
  stringify.property = function (property, designSet, noFold) {
    ...
    for (paramName in params) {
      ...
      if (params.hasOwnProperty(paramName)) {
        var multiValue =
          paramName in designSet.param &&
          designSet.param[paramName].multiValue;
  ...
  parser._parseParameters = function (line, start, designSet) {
    ...
    while (
      ...
      if (nextChar === '"') {
        ...
        // move to next ";"
        var nextPos = helpers.unescapedIndexOf(
          line,
          PARAM_DELIMITER,
          valuePos,
        );
...
(function () {
   ...
   */
  ICAL.Time.fromDayOfYear = function icaltime_fromDayOfYear(
    aDayOfYear,
    aYear,
  ) {
    var year = aYear;
